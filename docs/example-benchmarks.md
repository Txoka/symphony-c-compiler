...
|---|---|---:|---:|---:|---:|---|---|
| `arena_allocator.c` | `[]` | 788 | 310 | 1,252 | 553 | pending | pending |
| `bigprime.c` | `[]` | 7,660 | 512,184,732 | 11,704 | 967,067,881 | pending | pending |
| `constant_folding.c` | `[]` | 8 | 1 | 8 | 1 | pending | pending |
| `demo.c` | `[]` | 2,312 | 5,209 | 3,068 | 6,896 | pending | pending |
| `dynamic_sensor_report.c` | `[8, 4, -2, 4, 9, 0, -2, 7, 1]` | 8,864 | 14,949 | 12,960 | 19,788 | pending | pending |
| `insertion_sort.c` | `[15, 3, 9, 0, 14, 2, 8, 1, 13, 4, 12, 5, 11, 6, 10, 7]` | 524 | 3,554 | 864 | 7,185 | pending | pending |
| `interprocedural_constant_folding.c` | `[]` | 8 | 1 | 8 | 1 | pending | pending |
| `pi.c` | `[]` | 3,120 | 1,768,411,009 | 5,240 | 5,225,253,518 | pending | pending |
| `primes.c` | `[]` | 2,444 | 4,183,851 | 3,428 | 6,962,874 | pending | pending |
| `towers_of_hanoi.c` | `[2, 0, 2, 1]` | 276 | 245 | 312 | 272 | pending | pending |
